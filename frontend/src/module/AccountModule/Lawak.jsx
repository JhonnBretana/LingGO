        ...
        <BackgroundLayout>
            ...
            <div className="flex flex-col items-center text-center px-3 py-6 min-h-screen justify-center relative">
                ...
                <h1 className="text-white font-extrabold 
                    ...
                    Gaano kalawak ang iyong<br />kaalaman sa Cebuano?
                </h1>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center md:items-end 
                    ...
                    >
                        ...
                        <p className="absolute inset-0 flex items-center justify-center 
                            ...
                            Wala pa akong<br />sapat na<br />kaalaman sa<br />Cebuano.
                        </p>
                    </button>
                    ...
                    >
                        ...
                        <p className="absolute inset-0 flex items-center justify-center 
                                    ...
                                    leading-snug tracking-tight
                                    group-hover:scale-105 transition-transform duration-300">
                            May kaunti,<br />ngunit limitadong<br />kaalaman lamang<br />sa Cebuano.
                        </p>
                    </button>
                    ...
                    >
                        ...
                        <p
                            className="absolute inset-0 flex items-center justify-center 
                                        ...
                                        group-hover:scale-105 transition-transform duration-300"
                        >
                            Marunong <br />ako ng ilang salita at<br /> kaya kong makipag-usap<br />sa simpleng<br />Cebuano.
                        </p>
                    </button>
                </div>
            </div>
